...
class ExtractExifOnUpload
{
    public function handle(AssetUploaded $event): void
    {
        ...
        // Uniquement les JPEG du container photos
    ...
    private function camera(array $exif): ?string
    {
        ...
        // Évite la répétition "Canon Canon EOS …"
    ...
    {
        // COMPUTED contient déjà la valeur formatée "f/2.8"
    ...
    private function shutterSpeed(array $exif): ?string
    {
        ...
        if (str_contains($raw, '/')) {
            ...
            // Simplifie la fraction (ex: 2/1000 → 1/500)
    ...
    private function dateTaken(array $exif): ?string
    {
        ...
        // Format EXIF : "2024:06:15 14:32:00" → "2024-06-15 14:32:00"
